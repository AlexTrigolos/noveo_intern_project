...
RSpec.describe 'admin/bookings/show', type: :view do
  ...
  before do
    assign(:admin_booking, Admin::Booking.create!(email: 'alex@mail.ru', confirmed: false,
                                                  booking_token: 'MyStringsfghjkjhgfdsdfghj', number_people: 1,
                                                  room_id: room.id, check_in_date: '2023-01-01',
